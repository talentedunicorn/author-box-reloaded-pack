<?php
/*
Plugin Name: Author Box Reloaded Branchout Contact Addon
 ...
 * Section to modify
 */
function branchout_authorbox_add_sites( $known_sites ) {						// CHANGE the function prefix name
	$known_sites['Branchout'] = array(														// CHANGE the key name
		'favicon' => plugin_dir_url( __FILE__ ) . 'images/branchout.png',		// CHANGE the image name
		'url' => 'http://branchout.com/USERNAME',										// CHANGE the service URI 
		'plugin' => array (
...
add_filter('authorbox_known_sites','branchout_authorbox_add_sites',10,1);		// CHANGE the function prefix name
