<?php
/*
Plugin Name: Author Box Reloaded - Facebook Contact
Plugin URI: http://wordpress.org/extended/plugins/author-box-2/
Description: Adds Facebook to your profile. Just need to insert your UserID. Requires Author Box Reloaded 2.0 or greater.
Version: 1.0
...
$this_contact_name = 'Facebook'; 				// CHANGE this variable to the service name
...
function facebook_authorbox_add_sites( $known_sites ) {					// CHANGE the function prefix name
	$known_sites['Facebook'] = array(													// CHANGE the key name
		'favicon' => plugin_dir_url( __FILE__ ) . 'images/facebook.png',		// CHANGE the image name
		'url' => 'http://www.facebook.com/USERNAME',								// CHANGE the service URI 
  );
  return $known_sites;
}
add_filter('authorbox_known_sites','facebook_authorbox_add_sites',10,1);		// CHANGE the function prefix name
