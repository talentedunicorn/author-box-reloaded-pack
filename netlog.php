...
$this_contact_name = 'Netlog'; 				// CHANGE this variable to the service name
...
function netlog_authorbox_add_sites( $known_sites ) {					// CHANGE the function prefix name
...
add_filter('authorbox_known_sites','netlog_authorbox_add_sites',10,1);		// CHANGE the function prefix name
