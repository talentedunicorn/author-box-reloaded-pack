<?php
/*
Plugin Name: Author Box Reloaded - Drupal Association Contact
Plugin URI: http://wordpress.org/extended/plugins/author-box-2/
Description: Adds Drupal Association to your profile. Just need to insert your UserID. Requires Author Box Reloaded 2.0 or greater.
Version: 1.0
...
$this_contact_name = 'Drupal Association'; 				// CHANGE this variable to the service name
...
function drupal_ass_authorbox_add_sites( $known_sites ) {			// CHANGE the function prefix name
	$known_sites['Drupal Association'] = array(									// CHANGE the key name
		'favicon' => plugin_dir_url( __FILE__ ) . 'images/drupal.png',		// CHANGE the image name
		'url' => 'http://association.drupal.org/user/USERNAME',				// CHANGE the service URI 
  );
  return $known_sites;
}
add_filter('authorbox_known_sites','drupal_ass_authorbox_add_sites',10,1);		// CHANGE the function prefix name
