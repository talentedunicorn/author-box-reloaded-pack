<?php
/*
Plugin Name: Author Box Reloaded CrunchBase Contact Addon
 ...
 * Section to modify
 */
function crunchbase_authorbox_add_sites( $known_sites ) {					// CHANGE the function prefix name
	$known_sites['CrunchBase'] = array(													// CHANGE the key name
		'favicon' => plugin_dir_url( __FILE__ ) . 'images/crunchbase.png',		// CHANGE the image name
		'url' => 'http://www.crunchbase.com/person/USERNAME',					// CHANGE the service URI 
		'plugin' => array (
...
add_filter('authorbox_known_sites','crunchbase_authorbox_add_sites',10,1);		// CHANGE the function prefix name
